...
class GuiAlpha extends JFrame implements Runnable, ActionListener {
	...
	public GuiAlpha() {
		...
		myTorrent = new Torrent(new File("data/glee.torrent"));
		this.setTitle("Torrent : " + myTorrent.getMetainfo().getFileName());
		setLayout(new BorderLayout());
		setIconImage(Toolkit.getDefaultToolkit().getImage("src/gui/ico1.jpg"));
		menuBar = new JMenuBar();
		menuFile = new JMenu("File");
		menuHelp = new JMenu("Help");
		menuHelp.setToolTipText("Cliquez ici pour de l'aide :)");
